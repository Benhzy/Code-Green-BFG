...
import { Box, Heading, Text, Stack, SimpleGrid, Image, Flex } from '@chakra-ui/react'; 
    ...
    return (
        <Box p={2}>
            ...
            <Box>
                <SimpleGrid columns={2} spacing={2}>
                    <Stack paddingLeft = '5px'>
                        ...
                        <Text as='b' fontSize="2xl">{usedInfo}</Text>
                        <Text mt="-10px" fontSize="sm">items finished</Text>
                        </Stack>
                        </Flex>
                        </Box>
                    </Stack>
                    <Stack  paddingRight='5px'>
                        ...
                        <Text fontSize="4xl">🗑</Text>
                        <Stack paddingLeft="10px">
                        <Text as='b' fontSize="2xl">{thrownInfo}</Text>
                        <Text mt="-10px" fontSize="sm">items thrown</Text>
                        </Stack>
                        </Flex>
                        </Box>
                    </Stack>
                    ...
                    <Box
                        ...
                        <Text fontSize="4xl">📜</Text>
                        <Stack paddingLeft="10px">
                        <Text as='b' fontSize="2xl">2</Text>
                        <Text mt="-10px" fontSize="sm">recipes used</Text>
                        </Stack>
                        </Flex>
                        </Box>
                    </Stack>
                    ...
                    <Box
                        ...
                        <Text fontSize="4xl">🛍</Text>
                        <Stack paddingLeft="10px">
                        <Text as='b' fontSize="2xl">420</Text>
                        <Text mt="-10px" fontSize="sm">items logged</Text>
                        </Stack>
                        </Flex>
                        </Box>
                    </Stack>
            ...
            <Box 
                ...
                alignItems="center">
                    <Text fontSize="4xl">💎</Text>
                    <Stack spacing={0} justifyContent="center" display="flex" align="baseline" paddingLeft="10px">
                        <Text as="b" fontSize="lg" mb="-4px">$10</Text>
                        <Text>rewards</Text>
                    </Stack>
                </Box>
            <Box paddingTop="10px"></Box>
